...
public class HostPlaylist extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playButton = (Button) findViewById(R.id.playButton); // original add asset button
                        ...
                        mSpotifyAppRemote.getPlayerApi()
                                ...
                                .setEventCallback(new Subscription.EventCallback<PlayerState>() {
                                    ...
                                    public void onEvent(final PlayerState playerState) {
                                        playButton.setOnClickListener(new AdapterView.OnClickListener() {
                                            @Override
        ...
        myRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Toast.makeText(HostPlaylist.this, "The room code that was entered is " + enteredCode, Toast.LENGTH_SHORT).show();
...
//                }
    ...
    public void bindGridView() {
        ...
        gv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                try {
                    new AlertDialog.Builder(HostPlaylist.this)
    ...
    private void connected() {
        ...
        //PlayerState playerState = mSpotifyAppRemote.getPlayerApi().getPlayerState();
                ...
                .setEventCallback(new Subscription.EventCallback<PlayerState>() {
                    ...
                    public void onEvent(final PlayerState playerState) {
                        ...
                        if (track != null) {
                            ...
                            Toast.makeText(HostPlaylist.this, "Now playing: " + track.name + " by " + track.artist.name, Toast.LENGTH_LONG).show();
                        }
